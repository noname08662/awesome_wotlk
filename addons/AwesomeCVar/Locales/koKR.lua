...
if GetLocale() == "koKR" then
	...
	L.DESC_INERTIA = "이름표가 정렬된 위치까지 가속되는 속도를 조절합니다.\n값이 높을수록 움직임이 더 빠르고 즉각적입니다."
	L.DESC_HITBOX_ANCHOR = "0 = 상단 (아래로 확장); 1 = 중앙 (가운데에서 확장); 2 = 하단 (위로 확장)."
