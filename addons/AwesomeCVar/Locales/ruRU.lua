...
if GetLocale() == "ruRU" then
    ...
    L.DESC_STACKING_MODE = "0 = Выключено; 1 = Включить все; 2 = Только враги; 3 = Только союзники.\nПлюс = Стандарт; Минус = Умный режим (освобождает наложенные индикаторы при наличии места)."
	...
	L.DESC_INERTIA = "Определяет скорость ускорения индикаторов здоровья к их позициям при наслоении.\nВысокие значения делают движение более резким и мгновенным."
	L.DESC_HITBOX_ANCHOR = "0 = ВЕРХ (вниз); 1 = ЦЕНТР (из середины); 2 = НИЗ (вверх)."
