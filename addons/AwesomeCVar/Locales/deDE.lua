...
if GetLocale() == "deDE" then
	...
	L.DESC_INERTIA = "Steuert, wie schnell Namensplaketten auf ihre Stapelpositionen beschleunigen.\nHöhere Werte führen zu einer schnelleren und direkteren Bewegung."
	L.DESC_HITBOX_ANCHOR = "0 = OBEN (nach unten); 1 = MITTE (zentriert); 2 = UNTEN (nach oben)."
