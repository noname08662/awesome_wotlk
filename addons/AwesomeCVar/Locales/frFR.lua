...
if GetLocale() == "frFR" then
    ...
    L.DESC_STACKING_MODE = "0 = Désactivé ; 1 = Tout activer ; 2 = Ennemis uniquement ; 3 = Alliés uniquement.\nPositif = Standard; Négatif = Intelligent (libère les plaques superposées si l'espace est libre)."
	...
	L.DESC_INERTIA = "Contrôle la vitesse à laquelle les plaques de nom accélèrent vers leurs positions empilées.\nDes valeurs plus élevées entraînent un mouvement plus vif et immédiat."
	L.DESC_HITBOX_ANCHOR = "0 = HAUT (vers le bas); 1 = CENTRE (centré); 2 = BAS (vers le haut)."
