...
if GetLocale() == "enUS" then
    ...
    L.DESC_STACKING_MODE = "0 = Disabled; 1 = Enable All; 2 = Enemy Only; 3 = Friendly Only.\nPositive values = Standard; Negative values = Smart (free piggybacked plates if space is available)."
    ...
    L.DESC_HITBOX_ANCHOR = "0 = TOP (expand down); 1 = CENTER (expand middle); 2 = BOTTOM (expand up)."
	L.DESC_INERTIA = "Controls how quickly nameplates accelerate toward their target positions.\nHigher values result in snappier, more immediate movement."
