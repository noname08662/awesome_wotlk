...
if GetLocale() == "esMX" then
    ...
    L.DESC_STACKING_MODE = "0 = Desactivado; 1 = Activar todo; 2 = Solo enemigos; 3 = Solo aliados.\nPositivo = Estándar; Negativo = Inteligente (libera placas superpuestas si hay espacio)."
	...
	L.DESC_INERTIA = "Controla la rapidez con la que las placas de nombre aceleran hacia sus posiciones apiladas.\nLos valores más altos resultan en un movimiento más rápido e inmediato."
	L.DESC_HITBOX_ANCHOR = "0 = SUPERIOR (hacia abajo); 1 = CENTRO (expandir medio); 2 = INFERIOR (hacia arriba)."
