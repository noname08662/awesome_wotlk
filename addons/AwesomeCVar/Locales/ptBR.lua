...
if GetLocale() == "ptBR" then
	...
	L.DESC_INERTIA = "Controla a rapidez com que as placas de nome aceleram em direção às suas posições empilhadas.\nValores mais altos resultam em movimentos mais ágeis e imediatos."
	L.DESC_HITBOX_ANCHOR = "0 = TOPO (para baixo); 1 = CENTRO (expandir no meio); 2 = BASE (para cima)."
